...
app.use(express.urlencoded({extended:true})) //Sets up the parser

app.use(express.static(path.join(__dirname,'public'))) //Sets up the use of static files: img,vid,CSS,frontendJS

app.set('view engine','ejs') //sets up for rendering the .ejs file under views folder
